...
import org.bian.dto.BQFulfillmentRetrieveOutputModelFulfillmentInstanceAnalysis;
import org.bian.dto.BQFulfillmentRetrieveOutputModelFulfillmentInstanceReport;

import javax.validation.Valid;
  
/**
 * BQFulfillmentRetrieveOutputModel
 */
public class BQFulfillmentRetrieveOutputModel   {
  ...
  private String fulfillmentRetrieveActionTaskReference = null;

  private Object fulfillmentRetrieveActionTaskRecord = null;

  private String fulfillmentRetrieveActionResponse = null;

  private BQFulfillmentRetrieveOutputModelFulfillmentInstanceReport fulfillmentInstanceReport = null;

  private BQFulfillmentRetrieveOutputModelFulfillmentInstanceAnalysis fulfillmentInstanceAnalysis = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Fulfillment instance retrieve service call 
   * @return fulfillmentRetrieveActionTaskReference
  **/

  public String getFulfillmentRetrieveActionTaskReference() {
    return fulfillmentRetrieveActionTaskReference;
  }

  public void setFulfillmentRetrieveActionTaskReference(String fulfillmentRetrieveActionTaskReference) {
    this.fulfillmentRetrieveActionTaskReference = fulfillmentRetrieveActionTaskReference;
  }
  ...
  **/
   ...
   * @return fulfillmentRetrieveActionResponse
  **/

  public String getFulfillmentRetrieveActionResponse() {
    return fulfillmentRetrieveActionResponse;
  }

  public void setFulfillmentRetrieveActionResponse(String fulfillmentRetrieveActionResponse) {
    this.fulfillmentRetrieveActionResponse = fulfillmentRetrieveActionResponse;
  }
  ...
  **/
  ...
  public BQFulfillmentRetrieveOutputModelFulfillmentInstanceReport getFulfillmentInstanceReport() {
    return fulfillmentInstanceReport;
  }

  public void setFulfillmentInstanceReport(BQFulfillmentRetrieveOutputModelFulfillmentInstanceReport fulfillmentInstanceReport) {
  ...
  **/
  ...
  public BQFulfillmentRetrieveOutputModelFulfillmentInstanceAnalysis getFulfillmentInstanceAnalysis() {
    return fulfillmentInstanceAnalysis;
  }

  public void setFulfillmentInstanceAnalysis(BQFulfillmentRetrieveOutputModelFulfillmentInstanceAnalysis fulfillmentInstanceAnalysis) {
