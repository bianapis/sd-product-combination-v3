...
import org.bian.dto.BQTransferPricingRetrieveOutputModelTransferPricingInstanceAnalysis;
import org.bian.dto.BQTransferPricingRetrieveOutputModelTransferPricingInstanceReport;

import javax.validation.Valid;
  
/**
 * BQTransferPricingRetrieveOutputModel
 */
public class BQTransferPricingRetrieveOutputModel   {
  ...
  private String transferPricingRetrieveActionTaskReference = null;

  private Object transferPricingRetrieveActionTaskRecord = null;

  private String transferPricingRetrieveActionResponse = null;

  private BQTransferPricingRetrieveOutputModelTransferPricingInstanceReport transferPricingInstanceReport = null;

  private BQTransferPricingRetrieveOutputModelTransferPricingInstanceAnalysis transferPricingInstanceAnalysis = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Transfer Pricing instance retrieve service call 
   * @return transferPricingRetrieveActionTaskReference
  **/

  public String getTransferPricingRetrieveActionTaskReference() {
    return transferPricingRetrieveActionTaskReference;
  }

  public void setTransferPricingRetrieveActionTaskReference(String transferPricingRetrieveActionTaskReference) {
    this.transferPricingRetrieveActionTaskReference = transferPricingRetrieveActionTaskReference;
  }
  ...
  **/
   ...
   * @return transferPricingRetrieveActionResponse
  **/

  public String getTransferPricingRetrieveActionResponse() {
    return transferPricingRetrieveActionResponse;
  }

  public void setTransferPricingRetrieveActionResponse(String transferPricingRetrieveActionResponse) {
    this.transferPricingRetrieveActionResponse = transferPricingRetrieveActionResponse;
  }
  ...
  **/
  ...
  public BQTransferPricingRetrieveOutputModelTransferPricingInstanceReport getTransferPricingInstanceReport() {
    return transferPricingInstanceReport;
  }

  public void setTransferPricingInstanceReport(BQTransferPricingRetrieveOutputModelTransferPricingInstanceReport transferPricingInstanceReport) {
  ...
  **/
  ...
  public BQTransferPricingRetrieveOutputModelTransferPricingInstanceAnalysis getTransferPricingInstanceAnalysis() {
    return transferPricingInstanceAnalysis;
  }

  public void setTransferPricingInstanceAnalysis(BQTransferPricingRetrieveOutputModelTransferPricingInstanceAnalysis transferPricingInstanceAnalysis) {
