...
/**
 * CRProductCombinationArrangementExchangeInputModel
 */
public class CRProductCombinationArrangementExchangeInputModel   {
  ...
  private CRProductCombinationArrangementExchangeInputModelProductCombinationArrangementExchangeActionRequest productCombinationArrangementExchangeActionRequest = null;
  ...
  **/
  ...
  /**
   * Get productCombinationArrangementExchangeActionRequest
   * @return productCombinationArrangementExchangeActionRequest
  **/

  public CRProductCombinationArrangementExchangeInputModelProductCombinationArrangementExchangeActionRequest getProductCombinationArrangementExchangeActionRequest() {
    return productCombinationArrangementExchangeActionRequest;
  }

  public void setProductCombinationArrangementExchangeActionRequest(CRProductCombinationArrangementExchangeInputModelProductCombinationArrangementExchangeActionRequest productCombinationArrangementExchangeActionRequest) {
    this.productCombinationArrangementExchangeActionRequest = productCombinationArrangementExchangeActionRequest;
  }
